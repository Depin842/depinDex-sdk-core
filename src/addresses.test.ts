...
describe('addresses', () => {
  describe('swap router 02 addresses', () => {
    ...
    it('should return the correct address for bera', () => {
      const address = SWAP_ROUTER_02_ADDRESSES(ChainId.BERA)
      expect(address).toEqual('0xeB245A334cCD66668a8B4355b95E6a9A17CD2763')
    })
